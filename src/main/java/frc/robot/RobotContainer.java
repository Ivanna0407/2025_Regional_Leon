...
public class RobotContainer {
  ...
  //L3
  subdrive.a().whileTrue(new SequentialCommandGroup(new ParallelCommandGroup(new Cmd_Elevador_PID(Elevador, 4),
  new Cmd_Wrist_PID(Elevador, -180)), new Cmd_Set_Coral_Auto(Elevador,.2)));
  //Alga
  subdrive.povDown().whileTrue(new SequentialCommandGroup(new Cmd_Alga_PID(Alga, 5), new Cmd_Take_Alge_Auto(Alga)));
  //Home
  subdrive.start().whileTrue(new SequentialCommandGroup(new ParallelCommandGroup(new Cmd_Elevador_PID(Elevador, 0),
